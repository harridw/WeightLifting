...
There is a total of 160 variables in the data sets.  A quick review of the data will allow us to understand 
...
highNA <- subset(pctNA, pctNA >0.75)  ## variables / features with more than 75% NA
head(highNA, n = 20)
```
